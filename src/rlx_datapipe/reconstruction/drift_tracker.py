...
class DriftTracker:
    ...
    def calculate_drift(
        self, reconstructed_book: OrderBookState, snapshot_event: dict[str, Any]
    ) -> dict[str, float]:
    ...
    def _calculate_rms_error(
        self, reconstructed: list[tuple[Decimal, Decimal]], snapshot: list[list[Any]]
    ) -> float:
    ...
    def get_statistics(self) -> dict[str, float]:
        ...
        return {
            ...
            "resync_rate": (
                self.total_resyncs / self.total_snapshots
