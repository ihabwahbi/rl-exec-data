...
from .state_snapshot import StateSnapshot, PipelineState
...
class CheckpointManager:
    ...
    def load_latest_checkpoint_parquet(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            parquet_files = list(self.checkpoint_dir.glob(f"{self.symbol}_checkpoint_*.parquet"))
    ...
    async def recover_from_wal(self) -> int:
        ...
        try:
            ...
            last_checkpoint_update_id = (
                checkpoint_state.get("last_update_id", 0) 
            ...
            for segment in segments:
                if segment.last_update_id and segment.last_update_id > last_checkpoint_update_id:
                    ...
                    if not events_df.empty and "update_id" in events_df.columns:
                        new_events = events_df[events_df["update_id"] > last_checkpoint_update_id]
