...
def generate_report(results):
    ...
    print("=" * 80)
    print(f"Dataset: Crypto Lake BTC-USDT (Real production data from Epic 0)")
    print(f"Period: {results['date_range']['min']} to {results['date_range']['max']}")
    print()
    print(f"TRADES TABLE:")
    ...
    if results['invalid_percentage'] < 5:
        ...
        print(f"Strategy: origin_time_primary")
        ...
        print(f"Strategy: origin_time_with_fallback")
        ...
        print(f"Strategy: alternative_required")
...
def save_report(results):
    ...
    with open(report_path, 'w') as f:
        ...
        f.write(f"**Data Source**: Real Crypto Lake Data from Epic 0\n\n")
