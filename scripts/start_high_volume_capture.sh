#!/bin/bash
# start_high_volume_capture.sh
# Start 24-hour high volume capture during US market hours

CAPTURE_DIR="data/golden_samples/high_volume"
LOG_FILE="$CAPTURE_DIR/capture_$(date +%Y%m%d_%H%M%S).log"

echo "=== Starting High Volume Capture Session ==="
