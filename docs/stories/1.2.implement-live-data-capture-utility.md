...
4. The script captures multiple 20-48 hour windows representing different market regimes (high volume, low volume, special events)
...
- [x] Task 4: Implement market regime capture strategy (AC: 4)
  ...
  - [x] Implement 20-48 hour capture duration for each regime
...
- Duration parameter supports 20-48 hour captures
...
2. **Required**: Capture the planned 20-48 hour golden samples across different market regimes
